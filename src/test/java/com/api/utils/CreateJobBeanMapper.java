...
public class CreateJobBeanMapper {
	...
	public static CreateJobPayload mapper(CreateJobBean bean) {
        ...
        int mstPaltformId =  Integer.parseInt(bean.getMst_platform_id());
		...
		CreateJobPayload payload = new CreateJobPayload(mstServiceLocationId , mstPaltformId, mstWarrantyStatusId,oemId, customer, 
				customeraddress, 
				customerproduct, 
				problemList);
