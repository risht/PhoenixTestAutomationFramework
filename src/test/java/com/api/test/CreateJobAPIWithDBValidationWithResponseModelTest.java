...
public class CreateJobAPIWithDBValidationWithResponseModelTest {
	...
	public void setUp() {
		...
		customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "43144707147262", "43144707147262", "43144707147262", getTimeWithDaysAgo(10), 
	...
	public void createJobAPITest() {
		...
		int productId= createJobResponseModel.getData().getTr_customer_id();
